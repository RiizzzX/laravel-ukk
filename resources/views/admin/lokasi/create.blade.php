      ...
      <form action="{{ route('admin.lokasi.store') }}" method="POST" class="space-y-5">
        ...
        <div>
          ...
          <input type="text" name="nama_lokasi" value="{{ old('nama_lokasi') }}"
                 ...
                 placeholder="Masukkan nama lokasi (contoh: Kelas X-1)" required>
          @error('nama_lokasi')
        ...
        <div>
          <label class="block text-sm font-semibold text-gray-700 mb-2">Items (Opsional)</label>
          <p class="text-xs text-gray-500 mb-3">Anda bisa menambahkan items nanti setelah lokasi dibuat atau edit lokasi ini</p>
...
function confirmAddItem() {
  ...
  itemDiv.innerHTML = `
    <input type="text" name="items[${itemCount}][nama_item]" 
           ...
           placeholder="Nama item (contoh: Meja Siswa)" required>
