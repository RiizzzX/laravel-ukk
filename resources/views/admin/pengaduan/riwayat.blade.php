        ...
        <table class="w-full">
          <thead>
            <tr class="bg-emerald-50 border-b border-emerald-100">
              ...
              <th class="text-left px-6 py-4 text-xs font-semibold text-emerald-700 uppercase tracking-wider">Bukti User</th>
              <th class="text-left px-6 py-4 text-xs font-semibold text-emerald-700 uppercase tracking-wider">Bukti Petugas</th>
            </tr>
          </thead>
